...
<head>
    ...
    <title>Under Maintenance - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
    ...
    <link rel="stylesheet" type="text/css" href="../app-assets/css/pages/under-maintenance.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern 1-column  bg-maintenance-image blank-page" data-open="click" data-menu="vertical-menu-modern" data-col="1-column">
    <!-- BEGIN: Content-->
                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 box-shadow-3 m-0">
                                <div class="card-body">
                                    <span class="card-title text-center">
                                        <img src="../app-assets/images/logo/logo-dark-lg.png" class="img-fluid mx-auto d-block pt-2" width="250" alt="logo">
                                    </span>
                                </div>
