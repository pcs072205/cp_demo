            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-server"></i><span class="menu-title" data-i18n="Components">Components</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="active"><a class="menu-item" href="component-tabs-component.php"><i></i><span data-i18n="Tabs Component">Tabs Component</span></a>
                        </li>
                    ...
                    <div class="row match-height">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="baseLable-tab1" data-toggle="tab" aria-controls="tabLable1" href="#tabLable1" aria-expanded="true"><span class="badge badge-success">New</span> Tab 1</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="baseLable-tab2" data-toggle="tab" aria-controls="tabLable2" href="#tabLable2" aria-expanded="false">Tab 2</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="baseLable-tab3" data-toggle="tab" aria-controls="tabLable3" href="#tabLable3" aria-expanded="false"><span class="badge badge-info float-right">info</span> Tab 3 </a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link" id="homeLable-tab" data-toggle="tab" href="#homeLable" aria-controls="homeLable" aria-expanded="true"><span class="badge badge-danger">bug</span> Home</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active" id="profileLable-tab" data-toggle="tab" href="#profileLable" aria-controls="profileLable" aria-expanded="false"><span class="badge badge-primary float-right">latest</span> Profile </a>
                                            </li>
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                                    Dropdown
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="baseLable1-tab1" data-toggle="tab" aria-controls="tabLable11" href="#tabLable11" aria-expanded="true"><span class="badge badge-pill badge-glow badge-success">3</span> Tab 1</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="baseLable1-tab2" data-toggle="tab" aria-controls="tabLable12" href="#tabLable12" aria-expanded="false">Tab 2<span class="badge badge-pill badge-glow badge-warning float-right">2</span></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="baseLable1-tab3" data-toggle="tab" aria-controls="tabLable13" href="#tabLable13" aria-expanded="false"><span class="badge badge-pill badge-glow badge-info float-right">5</span> Tab 3
                                                </a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link" id="homeLable1-tab1" data-toggle="tab" href="#homeLable1" aria-controls="homeLable1" aria-expanded="true"><span class="badge badge-pill badge-glow badge-danger">4</span> Home</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link active" id="profileLable1-tab1" data-toggle="tab" href="#profileLable1" aria-controls="profileLable1" aria-expanded="false"><span class="badge badge-pill badge-glow badge-primary float-right">3</span> Profile </a>
                                            </li>
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                                    <span class="badge badge-pill badge-glow badge-success">2</span> Dropdown
                                                </a>
                                                <div class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="aboutLable1-tab1" data-toggle="tab" href="#aboutLable1" aria-controls="aboutLable1" aria-expanded="false"><span class="badge badge-pill badge-glow badge-warning">3</span> About</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content px-1 pt-1">
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-justified">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="activeLable-tab" data-toggle="tab" href="#activeLable" aria-controls="activeLable" aria-expanded="true"><span class="badge badge-success">new</span>
                                                    Active</a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="linkOptLable-tab" data-toggle="tab" href="#linkOptLable" aria-controls="linkOptLable"><span class="badge badge-danger">more</span> Link </a>
                                            </li>
                                        </ul>
                                        <div class="tab-content px-1 pt-1">
                        ...
                        <div class="col-xl-6 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>You can also use <code>.nav-justified.badge.badge-pill.badge-COLOR</code> classes to add label pill to
                                            justified tab.</p>
                                        <ul class="nav nav-tabs nav-justified">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="activeLable1-tab1" data-toggle="tab" href="#activeLable1" aria-controls="activeLable1" aria-expanded="true"><span class="badge badge-pill badge-glow badge-success">2</span> Active</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="linkLable1-tab1" data-toggle="tab" href="#linkLable1" aria-controls="linkLable1" aria-expanded="false"><span class="badge badge-pill badge-glow badge-info float-right">1</span> Link
                                                </a>
                                            </li>
                                            <li class="nav-item dropdown">
                                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                                    <span class="badge badge-pill badge-glow badge-danger">3</span> Dropdown
                                                </a>
                                                <div class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="linkOptLable1-tab1" data-toggle="tab" href="#linkOptLable1" aria-controls="linkOptLable1"><span class="badge badge-pill badge-glow badge-primary float-right">5</span> Link </a>
                                            </li>
                                        </ul>
                                        <div class="tab-content px-1 pt-1">
                        ...
                        <div class="col-xl-6 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>Wrap tabs and tab content with <code>.nav-vertical</code> class. To add left navigation use
                                            <code>.nav-left</code> &amp; use <code>nav-border-left</code>class to <code>.nav.nav-tabs</code> for
                                            leftside border effect to tab.</p>
                                        <div class="nav-vertical">
                        ...
                        <div class="col-xl-6 col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>Wrap tabs and tab content with <code>.nav-vertical</code> class. To add right navigation use
                                            <code>.nav-right</code> &amp; use <code>nav-border-right</code>class to <code>.nav.nav-tabs</code> for
                                            leftside border effect to tab.</p>
                                        <div class="nav-vertical">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="nav-vertical">
                                            <ul class="nav nav-tabs nav-right">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="baseVerticalRight2-tab2" data-toggle="tab" aria-controls="tabVerticalRight22" href="#tabVerticalRight22" aria-expanded="false"><i class="la la-header float-right"></i>
                                                        Profile</a>
                                                </li>
                                                <li class="nav-item">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="nav-vertical">
                                            <ul class="nav nav-tabs nav-left nav-border-left">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="baseVerticalLeft3-tab1" data-toggle="tab" aria-controls="tabVerticalLeft31" href="#tabVerticalLeft31" aria-expanded="true"><span class="mr-1 badge badge-success">New</span> Home</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="baseVerticalLeft3-tab2" data-toggle="tab" aria-controls="tabVerticalLeft32" href="#tabVerticalLeft32" aria-expanded="false"><span class="mr-1 badge badge-info">info</span>
                                                        Profile</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="baseVerticalLeft3-tab3" data-toggle="tab" aria-controls="tabVerticalLeft33" href="#tabVerticalLeft33" aria-expanded="false"><span class="mr-1 badge badge-warning badge-pill badge-glow">5</span> About</a>
                                                </li>
                                            </ul>
                                            <div class="tab-content px-1">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="nav-vertical">
                                            <ul class="nav nav-tabs nav-right nav-border-right">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="baseVerticalRight3-tab1" data-toggle="tab" aria-controls="tabVerticalRight31" href="#tabVerticalRight31" aria-expanded="true"><span class="mr-1 badge badge-pill badge-glow badge-danger float-right">2</span>Home </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="baseVerticalRight3-tab2" data-toggle="tab" aria-controls="tabVerticalRight32" href="#tabVerticalRight32" aria-expanded="false"><span class="mr-1 badge badge-pill badge-glow badge-primary float-right">3</span>Profile </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="baseVerticalRight3-tab3" data-toggle="tab" aria-controls="tabVerticalRight33" href="#tabVerticalRight33" aria-expanded="false"><span class="mr-1 badge badge-warning float-right">New</span>About </a>
                                                </li>
                                            </ul>
                                            <div class="tab-content px-1">
