...
<head>
    ...
    <title>Error 404 - Modern Admin - Clean Bootstrap 4 Dashboard HTML Template + Bitcoin Dashboard</title>
                            ...
                            <div class="card-content">
                                ...
                                <div class="row py-2">
                                    <div class="col-12 col-sm-6 col-md-6 mb-1">
                                        <a href="index.php" class="btn btn-primary btn-block"><i class="ft-home"></i> Home</a>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-6 mb-1">
                                        <a href="search-website.php" class="btn btn-danger btn-block"><i class="ft-search"></i> Search</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer bg-transparent">
                                <div class="row">
                                    <p class="text-muted text-center col-12 pb-1">© <span class="year"></span> <a href="#">Modern </a>Crafted with <i class="ft-heart pink"> </i> by <a href="http://themeforest.net/user/pixinvent/portfolio" target="_blank">PIXINVENT</a></p>
