                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-simple" action="index.php" novalidate>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6 col-12 text-center text-sm-right"><a href="recover-password.php" class="card-link">Forgot Password?</a></div>
                                            </div>
                                ...
                                <div class="card-footer">
                                    <div class="">
                                        <p class="float-xl-left text-center m-0"><a href="recover-password.php" class="card-link">Recover
                                                password</a></p>
                                        <p class="float-xl-right text-center m-0">New to Moden Admin? <a href="register-simple.php" class="card-link">Sign Up</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
