                            ...
                            <fieldset class="row py-1">
                                <div class="input-group col-12">
                                    ...
                                    <span class="input-group-append" id="button-addon2">
                                        <button class="btn btn-secondary border-grey border-lighten-1" type="button"><i class="la la-search"></i></button>
                                    </span>
                                </div>
                            </fieldset>
                            <div class="row py-2">
                                <div class="col-12">
                                    <a href="index.php" class="btn btn-primary btn-block"><i class="la la-home"></i> Back to Home</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer no-border pb-1 px-0">
                            <div class="text-center">
                                <a href="#" class="btn btn-social-icon mx-1 mb-1 btn-outline-facebook"><span class="la la-facebook"></span></a>
