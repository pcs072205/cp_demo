                        ...
                        <div class="col-lg-4 col-md-8 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    ...
                                    <p class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>Easily Using</span></p>
                                </div>
                                <div class="card-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-center">New to Modern Admin? <a href="register-with-navbar.php" class="card-link">Create
                                                Account</a></p>
                                    </div>
                                </div>
                            </div>
