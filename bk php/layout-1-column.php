            ...
            <div class="navbar-container content">
                <div class="collapse navbar-collapse" id="navbar-mobile">
                    <ul class="nav navbar-nav mr-auto float-left">
                        <li class="nav-item d-none d-md-block"><a class="nav-link nav-link-search fullscreen-search-btn" href="index.php"><i class="ft-arrow-left"></i>Back</a></li>
            ...
            <div class="content-body">
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <div class="card-text">
                                <p>1 Column layout is very useful for full width page requirements i.e: Contact us, Terms & Condition,
                                    Privacy policy etc..., It has Navbar with back to dashboard/home page option and footer, navigation
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>You can create 1 column layout by adding <code>.1-column</code> class in <code>&lt;body&gt;</code>
                                                    tag.</td>
                                            </tr>
                                        </tbody>
                                    </table>
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div class="card-text">
                                <p>This section contains HTML Markup to create 1 column layout. You need to add the <code>.1-column</code>
                                    class in the <code>&lt;body&gt;</code> tag as show in below markup on line no 4. Please note that 1
                                    column layout do not have Navigation section and it has back to Dashboard or Home page link in
                                    Navbar.</p>
